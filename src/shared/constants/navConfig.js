import {
  LayoutDashboard, CreditCard, PenLine, RefreshCw, LayoutTemplate, Package,
  BarChart2, Users, Smartphone, Globe2, Wallet, Bell, Link2, FileText,
...
export const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: PenLine,        label: "Write NFC Card",    id: "write-card",  badge: "New" },
      { icon: RefreshCw,      label: "Re-Write NFC Card", id: "rewrite-card"              },
      { icon: LayoutTemplate, label: "Templates (NFC)",   id: "templates",   children: [
  ...
  },
  {
    section: "ANALYTICS",
    items: [
      { icon: BarChart2, label: "Scan & Analytics", id: "scan-analytics", children: [
      ...
      { icon: Users, label: "Leads & Users", id: "leads", children: [
...
export const MOBILE_RAIL = [
  ...
  { icon: FileText,        label: "Logs",       id: "activity-logs"  },
  { icon: Settings,        label: "Settings",   id: "settings"       },
];
